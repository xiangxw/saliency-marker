    ...
    , imageScrollArea(new ImageScrollArea)
{
    ...
    imageScrollArea->setBrushValue(double(ui->brushValueDoubleSpinBox->value()));
    ...
    connect(ui->brushValueDoubleSpinBox, SIGNAL(valueChanged(double)),
            imageScrollArea, SLOT(setBrushValue(double)));
}
    ...
    if (watched == imageLabel) {
        ...
        case QEvent::MouseMove:
            ...
            if (mouseEvent->buttons() & Qt::LeftButton) {
                ...
                painter.fillRect(mouseEvent->x() - m_brushWidth, mouseEvent->y() - m_brushWidth,
                        m_brushWidth * 2, m_brushWidth * 2, m_brushColor);
                painter.end();
